        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        <a href="{{ route('pegawai.create') }}" class="btn btn-primary"><i class="fa fa-plus"> Tambah Data</i></a>
                         <a href="{{ route('export.pdf.pegawai') }}" class="btn btn-danger"><i class="fa fa-file-pdf"> Export PDF</i></a>
                ...
                <div class="card-body table-responsive p-0">
                    <table id="pegawaiTable" class="table table-hover text-nowrap">
                        <thead>
                        <tr>
                            <th>NIP</th>
                            <th>Nama Pengajar</th>
                    ...
                    if (result.value) {
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                $('#pegawaiTable').DataTable().ajax.reload(); // Reload DataTable
                            },
                        });
                    }
                });
