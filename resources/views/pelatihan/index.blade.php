            ...
            <div class="card">
                ...
                <div class="card-header">
                    <h3 class="card-title mb-3">
                        <a href="{{ route('pelatihan.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Tambah Data</a>
                ...
                <div class="card-body table-responsive p-0">
                    <table id="pelatihanTable" class="table table-bordered table-hover">
                        <thead>
                            <tr>
                                <th>Judul</th>
                                <th>Tanggal</th>
                        ...
                        <tbody>
                            @forelse($pelatihan as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('pelatihan.show', $item->id) }}" class="btn btn-info btn-sm"><i class="fa fa-eye"></i></a>
                                        <a href="{{ route('pelatihan.edit', $item->id) }}" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
